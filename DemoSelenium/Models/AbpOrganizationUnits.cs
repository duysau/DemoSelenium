...
namespace DemoSelenium.Models
{
    public partial class AbpOrganizationUnits
    {
        public AbpOrganizationUnits()
        {
            ...
            OrganizationUnitServicePoint = new HashSet<OrganizationUnitServicePoint>();
        }
        ...
        public virtual ICollection<OrganizationUnitServicePoint> OrganizationUnitServicePoint { get; set; }
    }
}
